    ...
    <article className={mobileCard}>
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          <p className={mobileSectionLabel}>{t("table.price")}</p>
          <div className="mt-1">
      ...
      <div className="space-y-2.5">
        <div>
          <p className={mobileSectionLabel}>{t("table.cargoCol")}</p>
        ...
        {transport !== "—" && (
          <div>
            <p className={mobileSectionLabel}>{t("table.transport")}</p>
      ...
      <div className={cn(mobileCardDivider, "mb-0")} />

      <div>
        <p className={cn(mobileSectionLabel, "mb-2")}>{t("table.customer")}</p>
